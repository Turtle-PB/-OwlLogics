    ...
    html += '<div class="panel" style="border-color:var(--purple);border-width:1px">' +
      ...
      '<div class="panel-body">' +
        ...
        '<div style="margin-top:10px;padding-top:10px;border-top:1px solid var(--border);font-size:10px;color:var(--text-muted);text-align:center">' +
          'OwlLogics NexGen Owl Mode — MIT License | Built by OwlLogics Contributors 🦉<br>' +
          '<a href="https://www.paypal.com/paypalme/adcockp" target="_blank" style="display:inline-block;margin-top:6px;padding:6px 16px;background:#0070ba;color:white;text-decoration:none;border-radius:5px;font-size:11px;font-weight:600">💖 Donate via PayPal</a>' +
          '<a href="https://www.patreon.com/adcockp" target="_blank" style="display:inline-block;margin-top:6px;margin-left:6px;padding:6px 16px;background:#f96854;color:white;text-decoration:none;border-radius:5px;font-size:11px;font-weight:600">🎨 Patreon</a><br>' +
