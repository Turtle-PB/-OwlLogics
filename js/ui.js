    ...
    html += '<div class="panel" style="border-color:var(--purple);border-width:1px">' +
      ...
      '<div class="panel-body">' +
        ...
        '<div style="margin-top:10px;padding-top:10px;border-top:1px solid var(--border);font-size:10px;color:var(--text-muted);text-align:center">' +
          ...
          '<a href="https://www.paypal.com/paypalme/adcockp" target="_blank" style="display:inline-block;margin-top:6px;padding:6px 16px;background:#0070ba;color:white;text-decoration:none;border-radius:5px;font-size:11px;font-weight:600">💖 Donate via PayPal</a><br>' +
